...
class entity_data_new_class:
    ...
    def __init__(self):
        ...
        self.param_update_entity_017 = [{"agent_id": os.environ.get("agent_id"),
                                       ...
                                       }, ['res["mutateOperationResponses"][0]["entity"] is not None', 'res["mutateOperationResponses"][0]["entity"]["type"] == "REGEX"'], {}]
        ...
        self.param_update_entity_024 = [{"agent_id": os.environ.get("agent_id"),
                                       ...
                                       }, ['res["mutateOperationResponses"][0]["entity"] is not None', 'res["mutateOperationResponses"][0]["entity"]["type"] == "ENUM"'], {}]
        ...
        self.param_update_entityvalue_022 = [{"agent_id": os.environ.get("agent_id"),
            ...
            , ['res["mutateOperationResponses"][0]["entityValue"]["id"] == os.environ.get("entity_value_id")',
               'res["mutateOperationResponses"][0]["entityValue"]["entityId"] == os.environ.get("entityId")'], {}]
        ...
        self.param_get_entity_020 = [{"agent_id": " ", "entity_type": " ",
                                          ...
                                          "page_size": " ",
                                          "keywords": get_str(3),
                                    "require_value":" "}, ['res["code"] == 3', '"type mismatch, parameter: agent_id, error:" in res["message"]'], {}]
        ...
        self.param_get_entityvalue_021 = [{"agent_id": " ", "entity_id": " ",
                                                ...
                                                "page_size": " ",
                                                "keywords": " ",
                                                "is_tokenization":True}, ['res["code"] == 3', '"type mismatch, parameter: agent_id, error:" in res["message"]'], {}]
