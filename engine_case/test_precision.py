...
class PrecisionCase:
    ...
    def process_run(self, proce_num):
        ...
        save_excel_lis = []
        for i in range(proce_num):
            save_path = f'/Users/chengxinfei/PycharmProjects/MyCode/result/{self.excel_name}_process_{i}.xlsx'
    ...
    def recall_rate(self, files):
        ...
        df_path = f"/Users/chengxinfei/PycharmProjects/MyCode/result/{self.excel_name}_recall.xlsx"
